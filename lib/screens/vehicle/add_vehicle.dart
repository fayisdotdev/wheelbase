          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                const SizedBox(height: 12),
                _buildDateField("Insurance Start", _insuranceStarts,
                    (date) => setState(() => _insuranceStarts = date)),
                _buildDateField("Insurance End", _insuranceEnds,
                    (date) => setState(() => _insuranceEnds = date)),
                _buildDateField("Pollution Start", _pollutionStarts,
                    (date) => setState(() => _pollutionStarts = date)),
                _buildDateField("Pollution End", _pollutionEnds,
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(labelText: "Battery (Optional)"),
                ),
                const SizedBox(height: 12),
                TextFormField(
                  controller: _alignmentController,
                  decoration: const InputDecoration(labelText: "Alignment (Optional)"),
                ),
                const SizedBox(height: 12),
                TextFormField(
